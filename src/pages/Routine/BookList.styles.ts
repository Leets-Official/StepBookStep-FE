...
export const tabContainer = "flex w-full flex-shrink-0 justify-center bg-gray-50";

export const content = "flex-1 px-5 py-2 overflow-y-auto pb-24 w-full box-border no-scrollbar gap-1";
