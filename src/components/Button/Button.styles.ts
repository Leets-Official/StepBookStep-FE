...
export const variants: Record<Variant, string> = {
  ...
  secondaryOutline:
    "bg-white text-lime-600 border border-lime-600 hover:bg-lime-400/30 hover:border-lime-600 active:bg-lime-400/65 active:text-black disabled:bg-white disabled:text-gray-300 disabled:border-gray-200 disabled:text-sm",
